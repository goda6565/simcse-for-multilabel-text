...
from train_configs.dscl import training_args
...
from bert.collates.sup_label import sup_train_collate_fn
from bert.models.dscl import SimCSEModel

import wandb

wandb.init(project="SimCSE-for-multilabel", name="dscl")
...
# エンコーダを保存
encoder_path = "outputs/dscl/encoder"
